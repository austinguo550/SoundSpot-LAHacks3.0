...
public interface Constants {
  ...
  // Sampling frequency (number of sample values per second) previously 22050 44100
  ...
  // Sound duration of encoded byte (in seconds) previously .2
  public static final double kDuration = 0.03; // rps - increased from 0.1 to improve reliability on Android
